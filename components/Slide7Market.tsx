      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="relative h-[420px] flex items-center justify-center overflow-visible">
          ...
          {markets.map((market, index) => (
            ...
            >
              ...
              >
                <p className="text-[#F9F5EE] mb-1 whitespace-nowrap" style={{ fontFamily: 'DM Sans, sans-serif' }}>
                  {market.name}
                </p>
                <p className="text-3xl text-[#F9F5EE] whitespace-nowrap" style={{ fontFamily: 'Lora, serif' }}>
                  {market.value}
                </p>
              </motion.div>
            </motion.div>
        ...
        >
          {[
            ...
            <motion.div 
              key={stat.label} 
              className="text-center bg-[#F9F5EE]/5 backdrop-blur-sm rounded-3xl p-6 border border-[#F9F5EE]/10 hover:border-[#F26B2D]/50 transition-all duration-300"
